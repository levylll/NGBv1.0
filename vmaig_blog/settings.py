...
EMAIL_HOST_USER = 'levylll@163.com'                  #我自己的邮箱 例如: xxxxxx@163.com
EMAIL_HOST_PASSWORD = 'lai3488long'              #我的邮箱密码 例如  xxxxxxxxx
EMAIL_SUBJECT_PREFIX = u'demo_password'       #为邮件Subject-line前缀,默认是'[django]'
